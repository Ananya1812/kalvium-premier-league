...
function filterByAwardxCountry(awardname, countryname) {
  ...
  let playersfilteredbyawardxcountry = playersfilteredbyawardx.filter(
    (item) => {
...
function FilterByTeamxSortByNoOfAwards(team) {
  let playersfilteredbyteam = players.filter((item) => {
    return item.team == team;
  });
  for (let i = 0; i < playersfilteredbyteam.length; i++) {
    for (let j = i + 1; j < playersfilteredbyteam.length; j++) {
      if (
        playersfilteredbyteam[i].awards.length <
        playersfilteredbyteam[j].awards.length
      ) {
...
function SortByNamexAwardxTimes(awardname, times, country) {
  ...
  let playersfilteredbyawardxtimesxcountry = playersfilteredbyawardxtime.filter(
    (item) => {
  ...
  for (let i = 0; i < playersfilteredbyawardxtimesxcountry.length; i++) {
    for (let j = i + 1; j < playersfilteredbyawardxtimesxcountry.length; j++) {
      if (
        playersfilteredbyawardxtimesxcountry[i].name >
        playersfilteredbyawardxtimesxcountry[j].name
      ) {
        let temp = playersfilteredbyawardxtimesxcountry[i];
        playersfilteredbyawardxtimesxcountry[i] =
          playersfilteredbyawardxtimesxcountry[j];
...
function SortByNamexOlderThan(age) {
  let playersfilteredbyage = players.filter((item) => {
    return item.age > age;
  });
